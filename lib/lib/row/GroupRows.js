  ...
  _createClass(GroupRows, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          onRowClickStart = _this$props.onRowClickStart,
          onRowClickEnd = _this$props.onRowClickEnd,
      ...
      var _loop = function _loop(i) {
        lines.push(_react["default"].createElement(_GroupRow["default"], {
          ...
          onClickStart: function onClickStart(evt) {
            return onRowClickStart(evt, i);
          },
          onClickEnd: function onClickEnd(evt) {
            return onRowClickEnd(evt, i);
          },
          ...
          style: {
            ...
            height: "".concat(groupHeights[i] - 1, "px")
          }
        }));
      };
...
_defineProperty(GroupRows, "propTypes", {
  ...
  onRowClickStart: _propTypes["default"].func.isRequired,
  onRowClickEnd: _propTypes["default"].func.isRequired,
