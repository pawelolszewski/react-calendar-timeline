...
var _domHelpers = require('react-calendar-timeline/lib/utility/dom-helpers');
  ...
  this.getTimeFromRowClickEvent = function (e) {
    ...
    if (offsetX === undefined) {
      if (typeof e.nativeEvent.touches !== 'undefined' && e.nativeEvent.touches.length > 0) {
        ...
        return (e.nativeEvent.touches[0].pageX - offset + scrolls.scrollLeft) * ratio + _this4.state.canvasTimeStart;
      }
    }
