...
ReactCalendarTimeline.propTypes = {
  ...
  onCanvasClickStart: _propTypes2.default.func,
  onCanvasClickEnd: _propTypes2.default.func,
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getTimeFromRowClickEvent = function (e) {
    ...
    if (offsetX === undefined) {
      ...
      var ratio = (0, _calendar.coordinateToTimeRatio)(_this4.state.canvasTimeStart, _this4.state.canvasTimeEnd, (0, _calendar.getCanvasWidth)(_this4.state.width));
      var offset = (0, _domHelpers.getSumOffset)(_this4.scrollComponent).offsetLeft;
      var scrolls = (0, _domHelpers.getSumScroll)(_this4.scrollComponent);
      time = (touchOffsetX - offset + scrolls.scrollLeft) * ratio + _this4.state.canvasTimeStart;
    }
    // For mouse events
    else {
  ...
  this.handleRowClickStart = function (e, rowIndex) {
    if (_this4.state.selectedItem) {
      _this4.selectItem(null);
    }
    ...
    if (_this4.props.onCanvasClickStart == null) return;

    var time = _this4.getTimeFromRowClickEvent(e);
    var groupId = (0, _generic._get)(_this4.props.groups[rowIndex], _this4.props.keys.groupIdKey);
    e.preventDefault();
    _this4.props.onCanvasClickStart(groupId, time, e);
  };

  this.handleMouseMove = function (e, rowIndex) {
    if (_this4.props.onMouseMove == null) return;

    if (_this4.state.isMouseDown) {
      var time = _this4.getTimeFromRowClickEvent(e);
      var groupId = (0, _generic._get)(_this4.props.groups[rowIndex], _this4.props.keys.groupIdKey);

      _this4.props.onMouseMove(groupId, time, e);
    }
    e.stopPropagation();
    e.preventDefault();
  };

  this.handleRowClickEnd = function (e, rowIndex) {
    if (_this4.props.onCanvasClickEnd == null) return;
    ...
    _this4.props.onCanvasClickEnd(groupId, time, e);
  };
