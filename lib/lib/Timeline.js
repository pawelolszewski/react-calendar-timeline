...
function (_Component) {
  ...
  function ReactCalendarTimeline(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "dragItem", function (item, dragTime, oldGroup, dragGroupDelta) {
      ...
      var newGroupOrder = Object.keys(oldGroup).map(function (gr) {
    ...
    _defineProperty(_assertThisInitialized(_this), "dropItem", function (item, dragTime) {
      _this.setState({
        draggingItem: null,
        dragTime: null,
        dragGroupTitle: null
      ...
      if (_this.props.onItemMove) {
        _this.props.onItemMove(item, dragTime, _this.state.newGroupOrder);
      }
    });
