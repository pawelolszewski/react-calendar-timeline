...
function (_Component) {
  ...
  _createClass(Item, [{
    ...
    key: "dragGroupDelta",
    value: function dragGroupDelta(e, itemIndex) {
      var _this$props2 = this.props,
          groupTops = _this$props2.groupTops,
          itemOrder = _this$props2.itemOrder;
    ...
    key: "mountInteract",
    value: function mountInteract(item, itemIndex) {
      var _this2 = this;
      ...
      (0, _interactjs["default"])(item).resizable({
        edges: {
        ...
        if (_this2.state.dragging) {
          ...
          var dragGroupDelta = _this2.dragGroupDelta(e, itemIndex);
        ...
        if (_this2.state.dragging) {
          if (_this2.props.onDrop) {
            ...
            _this2.props.onDrop(_this2.itemId, dragTime, _this2.props.invisibleGroups);
          }
    ...
    key: "enableInteract",
    value: function enableInteract(prevProps) {
      var _this3 = this;
      ...
      if (!!this.item) {
        if (this.props.selected && !interactMounted) {
          this.item && this.item.forEach(function (el, index) {
            _this3.mountInteract(el, index);
          });
          interactMounted = true;
        }
        ...
        if (interactMounted && (couldResizeLeft !== willBeAbleToResizeLeft || couldResizeRight !== willBeAbleToResizeRight)) {
          ...
          this.item.forEach(function (el) {
            (0, _interactjs["default"])(el).resizable({
...
_defineProperty(Item, "propTypes", {
  ...
  invisibleGroups: _propTypes["default"].array,
  itemOrder: _propTypes["default"].object,
