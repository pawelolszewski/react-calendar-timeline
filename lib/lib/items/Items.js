  ...
  _createClass(Items, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement("div", {
        ...
        var itemGroup = (0, _generic._get)(item, itemGroupKey);
        var tt = Object.keys(groupOrders).filter(function (key) {
          return itemGroup.includes(key) || itemGroup.includes(parseInt(key));
        ...
        return _react["default"].createElement(_Item["default"], {
          ...
          item: item,
          keys: _this.props.keys,
          order: Object.keys(tt)[0] && groupOrders[Object.keys(tt)[0]] || groupOrders[(0, _generic._get)(item, itemGroupKey)],
          dimensions: sortedDimensionItems[(0, _generic._get)(item, itemIdKey)].dimensions //Automatically select all items.
          // selected={true}
          ,
...
_defineProperty(Items, "propTypes", {
  ...
  pointerEventsDisabled: _propTypes["default"].bool.isRequired,
